export type AdminStickerPack = {
  ...
  isFeatured: boolean; isActive: boolean; sortOrder: number; availableFrom: string | null;
...
export type SaveStickerPack = Pick<AdminStickerPack, 'name' | 'description' | 'thumbnailUrl' | 'price' | 'isFeatured' | 'isActive' | 'sortOrder' | 'availableFrom' | 'availableUntil'>;
